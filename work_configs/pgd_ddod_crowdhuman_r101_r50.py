...
distiller = dict(
    ...
    teacher_pretrained = 'work_dirs/crowd_ddod_r101_3x_ms/epoch_36.pth',
    init_student = True,
...
student_cfg = 'work_configs/det_crowdhuman/ddod_r50_distill_head.py'
teacher_cfg = 'work_configs/det_crowdhuman/ddod_r101.py'
